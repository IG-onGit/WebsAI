...
If CSS styling is provided above - use similar visual styling for user required CSS code block if required.
...
You must generate required well structured code blocks for this user request:
[[message]]
